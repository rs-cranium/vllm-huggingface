...
DTYPE=${DTYPE:-"auto"}
TRUST_REMOTE_CODE=${TRUST_REMOTE_CODE:-true} # was false
...
# Execute the command
eval "export VLLM_ALLOW_LONG_MAX_MODEL_LEN=$VLLM_ALLOW_LONG_MAX_MODEL_LEN"
# eval "export VLLM_ATTENTION_BACKEND=FLASH_ATTN"
eval "export VLLM_ATTENTION_BACKEND=FLEX_ATTENTION"
eval "export VLLM_USE_FLASHINFER_SAMPLER=0"
eval $CMD
